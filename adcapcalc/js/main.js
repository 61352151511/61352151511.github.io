  ...
  function calcState(loc) {
    ...
    for (; i < loc.investments.length; i++) {
      ...
      if (loc.triples > 0 || loc.bonusMultiplier > 0) {
        loc.investments[i][3] *= 1 + (3 * loc.triples) + loc.bonusMultiplier;
      }
