...
advApp.controller('advController', ['$document', '$filter', '$scope', function($document, $filter, $scope) {
  ...
  $scope.superbadgeList = [
    /* ['Name', Planet ID, [Investment, Multiplier]] */
  ...
  var planets = ['earth', 'moon', 'mars', 'lyp'];
...
/*        if ($scope.selectAll[1]) {
  ...
  function loadDefaults() {
    $scope.lyp.angelScale = 3;
    $scope.lyp.baseCost = [0, 0, 0, 0, 0, 0, 0, 0, 0];
    $scope.lyp.basePower = [0, 0, 0, 0, 0, 0, 0, 0, 0]; // Cost 1 / Cost 2
    $scope.lyp.baseProfit = [0, 0, 0, 0, 0, 0, 0, 0, 0];
    $scope.lyp.baseSpeed = [0, 0, 0, 0, 0, 0, 0, 0, 0];
  ...
  function loadUnlocks() {
    $scope.lyp.unlocks[0] = [[1, [1, 1]]]; // [Amount Owned, [Investment Speed/Investment Profit, Multiplier]]
    $scope.lyp.unlocks[1] = [[1, [1, 1]]];
    $scope.lyp.unlocks[2] = [[1, [1, 1]]];
    $scope.lyp.unlocks[3] = [[1, [1, 1]]];
    $scope.lyp.unlocks[4] = [[1, [1, 1]]];
    $scope.lyp.unlocks[5] = [[1, [1, 1]]];
    $scope.lyp.unlocks[6] = [[1, [1, 1]]];
    $scope.lyp.unlocks[7] = [[1, [1, 1]]];
    $scope.lyp.unlocks[8] = [[1, [1, 1]]];
    $scope.lyp.unlocks[9] = [[1, [1, 1]]];
    $scope.lyp.cashUpgrades = [[1, [1, 1], false]]; // [Cost, [Investment Speed/Investment Profit, Multiplier], false]
    $scope.lyp.angelUpgrades = [[1, [1, 1], false, false]]; // [Cost, [Investment Speed/Investment Profit, Multiplier], false, false]
