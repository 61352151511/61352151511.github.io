...
advApp.controller('advController', ['$document', '$filter', '$scope', function($document, $filter, $scope) {
  ...
  var planets = ['earth', 'moon', 'mars', 'coins'];
...
/*        if ($scope.selectAll[1]) {
  ...
  function loadUnlocks() {
    ...
    // 0 - Explosive Dudes Profit
    // 1 - Explosive Dudes Speed
    // 2 - Silver Blade Profit
    // 3 - Silver Blade Speed
    // 4 - Primate Paradise Profit
    // 5 - Primate Paradise Speed
    // 6 - Flemmings Profit
    // 7 - Flemmings Speed
    // 8 - Fightingfrogs Profit
    // 9 - Fightingfrogs Speed
    // 10 - Crow & Jack Profit
    // 11 - Crow & Jack Speed
    // 12 - Street Skid 2 Profit
    // 13 - Streed Skid 2 Speed
    // 14 - Rad Cap Profit
    // 15 - Rad Cap Speed
    // 16 - Space Worm Ted Profit
    // 17 - Space Worm Ted Speed
    ...
    $scope.coins.cashUpgrades = [[25700, [18, 13.37], false], [2680000, [18, 13.37], false], [279e+6, [18, 13.37], false], [281e+10, [18, 13.37], false], [292e+13, [18, 13.37], false], [303e+16, [18, 13.37], false], [314e+19, [18, 13.37], false], [325e+21, [18, 13.37], false], [336e+25, [18, 13.37], false], [347e+29, [18, 13.37], false], [358e+33, [18, 13.37], false], [369e+37, [18, 13.37], false], [371e+41, [18, 13.37], false], [382e+45, [18, 13.37], false], [393e+49, [18, 13.37], false], [404e+53, [18, 13.37], false], [415e+57, [18, 13.37], false], [426e+61, [18, 13.37], false], [437e+65, [18, 13.37], false], [448e+69, [18, 13.37], false], [459e+73, [18, 13.37], false]];
